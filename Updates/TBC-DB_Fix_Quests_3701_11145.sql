...
UPDATE `mangos`.`gameobject_template` SET `data1` = 3701 WHERE `entry` = 153556;
...
UPDATE `mangos`.`gameobject_template` SET `data2` = 24618320 WHERE `entry` = @CAGE;

DELETE FROM `mangos`.`dbscripts_on_go_template_use` WHERE `id` = @CAGE;
DELETE FROM `mangos`.`creature_movement` WHERE `id` IN (31050, 31074, 31072, 31641, 31639, 31645, 30923);
DELETE FROM `mangos`.`dbscripts_on_go_use` WHERE `id` IN (11707, 11184, 11719, 11710, 11708, 11185, 11183);
DELETE FROM `mangos`.`db_script_string` WHERE `entry` = @TEXT;

INSERT INTO `mangos`.`dbscripts_on_go_template_use` (`id`, `delay`, `command`, `datalong`, `datalong2`, `buddy_entry`, `search_radius`,`data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`) VALUES
...
INSERT INTO `mangos`.`creature_movement` (`id`, `point`, `position_x`, `position_y`, `position_z`, `waittime`, `script_id`, `textid1`, `textid2`, `textid3`, `textid4`, `textid5`, `emote`, `spell`, `orientation`, `model1`, `model2`) VALUES 

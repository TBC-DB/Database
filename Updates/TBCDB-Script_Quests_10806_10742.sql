...
UPDATE mangos.`creature` SET `Map` = 0 WHERE `id` = 22496; -- hide spawned Sabellian in TBC
UPDATE mangos.`creature` SET `Map` = 0 WHERE `id` = 20555; -- hide spawned Goc in TBC

UPDATE mangos.`item_template` SET `spellcharges_1` = '1' WHERE `entry` IN (@SIGNET, @HORN); -- Prevent multiple summon

UPDATE mangos.`creature_template` SET `UnitFlags` = '2', `MovementType` = '0', `FactionAlliance` = '14', `FactionHorde` = '14', `AIName` = 'EventAI' WHERE `entry` = @GOC;
UPDATE mangos.`creature_template` SET `MinLevel` = '72', `MaxLevel` = '72', `FactionAlliance` = '210', `FactionHorde` = '210', `UnitClass` = '2', `DamageMultiplier` = '7.5', `MinLevelHealth` = '22000', `MaxLevelHealth` = '22000', `MinLevelMana` = '0',  `MaxLevelMana` = '0',  `MinMeleeDmg` = '307', `MaxMeleeDmg` = '438', `MinRangedDmg` = '270', `MaxRangedDmg` = '401', `Armor` = '7318', `MeleeAttackPower` = '314', `EquipmentTemplateId` = '0', `MovementType` = '0' WHERE `entry` = @BARON;
UPDATE mangos.`creature_template` SET `MinLevel` = '72', `MaxLevel` = '72', `FactionAlliance` = '106', `FactionHorde` = '106', `UnitClass` = '2', `DamageMultiplier` = '7.5', `MinLevelHealth` = '22000', `MaxLevelHealth` = '22000', `MinLevelMana` = '0',  `MaxLevelMana` = '0',  `MinMeleeDmg` = '307', `MaxMeleeDmg` = '438', `MinRangedDmg` = '270', `MaxRangedDmg` = '401', `Armor` = '7318', `MeleeAttackPower` = '314', `EquipmentTemplateId` = '0', `MovementType` = '0' WHERE `entry` = @REXXAR;

DELETE FROM mangos.`dbscripts_on_event` WHERE `id` IN (@HORDE_EVENT, @ALLY_EVENT);
DELETE FROM mangos.`dbscripts_on_creature_death` WHERE `id` = @GOC;
DELETE FROM mangos.`db_script_string` WHERE `entry` BETWEEN 2000005898 AND 2000005908;
DELETE FROM mangos.`creature_ai_scripts` WHERE `creature_id` = @GOC;

INSERT INTO mangos.`dbscripts_on_event` (`id`,`delay`,`command`,`datalong`,`datalong2`,`buddy_entry`,`search_radius`,`data_flags`,`dataint`,`dataint2`,`dataint3`,`dataint4`,`x`,`y`,`z`,`o`,`comments`) VALUES
...
INSERT INTO mangos.`dbscripts_on_creature_death` (`id`,`delay`,`command`,`datalong`,`datalong2`,`buddy_entry`,`search_radius`,`data_flags`,`dataint`,`dataint2`,`dataint3`,`dataint4`,`x`,`y`,`z`,`o`,`comments`) VALUES
...
INSERT INTO mangos.`creature_ai_scripts` (`creature_id`,`event_type`,`event_inverse_phase_mask`,`event_chance`,`event_flags`,`event_param1`,`event_param2`,`event_param3`,`event_param4`,`action1_type`,`action1_param1`,`action1_param2`,`action1_param3`,`action2_type`,`action2_param1`,`action2_param2`,`action2_param3`,`action3_type`,`action3_param1`,`action3_param2`,`action3_param3`,`comment`) VALUES
